...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_student_id'])) {
    ...
    try {
        ...
        if ($student['photo_path']) {
            $photoPath = dirname(__DIR__) . str_replace('/SampleWeb', '', $student['photo_path']);
        ...
        if ($student['qr_code_path']) {
            $qrPath = dirname(__DIR__) . str_replace('/SampleWeb', '', $student['qr_code_path']);
            ...
            const idCardHTML = `
                <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
                    ...
                    <div class="id-card" data-student-id="${studentId}">
                        <div class="id-header">
                            <div class="id-logo">
                                <img src="<?= url_for('/assets/images/school_logo.png') ?>" alt="School Logo" style="width: 100%; height: 100%; object-fit: contain;">
                            </div>
                            ...
                            <div class="id-deped-logo">
                                <img src="<?= url_for('/assets/images/deped_logo.png') ?>" alt="DepEd Logo" style="width: 100%; height: 100%; object-fit: contain;">
                            </div>
                        </div>
