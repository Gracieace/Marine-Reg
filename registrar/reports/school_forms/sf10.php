...
<head>
    <meta charset="UTF-8">
    <title>SF10 - Permanent Record</title>
    <link rel="stylesheet" href="<?= url_for('/css/sidebar.css') ?>">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    <style>
        body { font-family: 'Inter', sans-serif; background: #eaeff2; margin: 0; padding: 20px; color: #1e293b; }
        ...
        .letterhead { text-align: center; margin-bottom: 30px; border-bottom: 1px solid #000; padding-bottom: 20px; }
        .letterhead h1 { font-size: 18px; margin: 5px 0; }
        ...
        .year-block { margin-bottom: 40px; border: 1px solid #000; }
        .year-header { background: #f1f5f9; padding: 8px 15px; border-bottom: 1px solid #000; display: flex; justify-content: space-between; font-weight: 700; font-size: 13px; }
        
        table { width: 100%; border-collapse: collapse; }
        th, td { border: 1px solid #000; padding: 6px 10px; font-size: 11px; text-align: center; }
        th { background: #f8fafc; }
        .subj-name { text-align: left; width: 50%; }
    ...
    <div class="container main-content">
        ...
        <?php if ($permanent_record): ?>
            <div class="letterhead">
                <h2 style="font-weight: 700;">Republic of the Philippines</h2>
                <h1>Department of Education</h1>
                <h2 style="font-weight: 700; text-transform: uppercase;">Learner's Permanent Record (SF10-ES)</h2>
            </div>
            ...
            <div style="margin-top: 50px; font-size: 11px; font-style: italic;">
                Certified True and Correct:
                <div style="margin-top: 30px; border-top: 1px solid #000; width: 250px; text-align: center; font-weight: 700;">School Registrar / Principal</div>
            </div>
        <?php else: ?>
