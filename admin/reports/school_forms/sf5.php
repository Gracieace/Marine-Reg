...
function handleExport($data, $format, $school_year, $grade_level, $section)
{
    ...
    if ($format === 'csv') {
        ...
        echo '<div style="text-align:center;"><div class="sig-line"></div><br><strong>Class Adviser</strong><br>Date: ' . date('M d, Y') . '</div>';
        echo '<div style="text-align:center;"><div class="sig-line">' . strtoupper($principal_name) . '</div><br><strong>School Head / Principal</strong><br>Certified Correct</div>';
        echo '</div>';
        ...
        <div class="container">
            ...
            <?php if ($filters_applied && !empty($reports)): ?>
                <div class="sf5-form">
                    ...
                    <div class="sf5-signature-section" style="justify-content: space-between;">
