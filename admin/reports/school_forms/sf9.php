...
<head>
    <meta charset="UTF-8">
    <title>SF9 - Individual Progress Card | Admin</title>
    <link rel="stylesheet" href="<?= url_for('/css/header.css') ?>">
    <link rel="stylesheet" href="<?= url_for('/css/sidebar.css') ?>">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    <style>
        body { font-family: 'Inter', sans-serif; background: #f4f6f9; margin: 0; padding: 20px; padding-top: var(--header-height); }
        .container { max-width: 100%; margin: 0; background: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
        ...
        @media print {
            ...
            .container { box-shadow: none; max-width: 100%; padding: 0; margin-top: 0; }
...
<body>
    ...
    <div class="container main-content">
        ...
        <?php if ($report_card): ?>
            ...
            <div class="footer-sig" style="margin-bottom: 50px;">
                <div>
                    <div class="sig-line">Class Adviser</div>
                </div>
                <div>
                    <div class="sig-line"><?= strtoupper($principal_name) ?></div>
                    <div style="font-size: 11px; font-weight: bold; margin-top: 5px;">School Head</div>
                </div>
            </div>
            
            <div class="no-print" style="text-align: center; color: #64748b; font-size: 12px; margin-top: 50px;">
