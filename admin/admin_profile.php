...
// Ensure columns exist for SF7 data (sharing schema with teachers)
$required_columns = [
    'tin' => 'VARCHAR(50)',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($action === 'update_info') {
            ...
            // Auto-assign SG if not provided
        ...
        elseif ($action === 'update_signature' && isset($_FILES['signature']) && $_FILES['signature']['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($ext, ['png', 'webp'])) {
                ...
                $filename = "admin_sig_" . $userId . "_" . time() . ".$ext";
                $targetPath = $uploadDir . '/' . $filename;
                ...
                $error = "Please upload a transparent PNG or WebP.";
            }
        }
    } catch (Exception $e) {
...
<body>
    ...
    <div class="main-content">
        <div class="profile-header-card">
            ...
            <div class="header-info">
                ...
                <p><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> <?= htmlspecialchars($user['position_title'] ?? 'Administrator') ?> (SG <?= htmlspecialchars($user['salary_grade'] ?? 'N/A') ?>)</p>
            </div>
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div style="text-align: right; margin-top: 24px;">
                            <button type="submit" class="btn btn-primary clickable">Save Profile Updates</button>
                        </div>
        ...
        <div id="professional" class="tab-content">
            <div class="helper-card">
                ...
                <p>These details are required for **School Form 7 (SF7)** reporting and official documentation.</p>
            </div>
            <div class="card">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <select name="position_title" id="position_title" class="form-control" onchange="autoSalaryGrade(event)">
                                    ...
                                    <optgroup label="Teaching Positions">
                                        ...
                                        <option value="Special Education Teacher I" <?= ($user['position_title'] ?? '') === 'Special Education Teacher I' ? 'selected' : '' ?>>Special Education Teacher I</option>
                                        <option value="Special Education Teacher II" <?= ($user['position_title'] ?? '') === 'Special Education Teacher II' ? 'selected' : '' ?>>Special Education Teacher II</option>
                                        <option value="Special Education Teacher III" <?= ($user['position_title'] ?? '') === 'Special Education Teacher III' ? 'selected' : '' ?>>Special Education Teacher III</option>
                                        <option value="Special Education Teacher IV" <?= ($user['position_title'] ?? '') === 'Special Education Teacher IV' ? 'selected' : '' ?>>Special Education Teacher IV</option>
                                        ...
                                        <option value="Master Teacher IV" <?= ($user['position_title'] ?? '') === 'Master Teacher IV' ? 'selected' : '' ?>>Master Teacher IV</option>
                                    </optgroup>
                                    <optgroup label="Leadership Positions">
                                        ...
                                        <option value="Head Teacher IV" <?= ($user['position_title'] ?? '') === 'Head Teacher IV' ? 'selected' : '' ?>>Head Teacher IV</option>
                                        <option value="Head Teacher V" <?= ($user['position_title'] ?? '') === 'Head Teacher V' ? 'selected' : '' ?>>Head Teacher V</option>
                                        <option value="Head Teacher VI" <?= ($user['position_title'] ?? '') === 'Head Teacher VI' ? 'selected' : '' ?>>Head Teacher VI</option>
                                        ...
                                        <option value="Principal III" <?= ($user['position_title'] ?? '') === 'Principal III' ? 'selected' : '' ?>>Principal III</option>
                                        <option value="Principal IV" <?= ($user['position_title'] ?? '') === 'Principal IV' ? 'selected' : '' ?>>Principal IV</option>
                                    </optgroup>
                                    <optgroup label="Administrative Positions">
                                        <option value="Administrative Assistant I" <?= ($user['position_title'] ?? '') === 'Administrative Assistant I' ? 'selected' : '' ?>>Administrative Assistant I</option>
                                        <option value="Administrative Assistant II" <?= ($user['position_title'] ?? '') === 'Administrative Assistant II' ? 'selected' : '' ?>>Administrative Assistant II</option>
                                        <option value="Administrative Assistant III" <?= ($user['position_title'] ?? '') === 'Administrative Assistant III' ? 'selected' : '' ?>>Administrative Assistant III</option>
                                        <option value="Administrative Officer I" <?= ($user['position_title'] ?? '') === 'Administrative Officer I' ? 'selected' : '' ?>>Administrative Officer I</option>
                                        <option value="Administrative Officer II" <?= ($user['position_title'] ?? '') === 'Administrative Officer II' ? 'selected' : '' ?>>Administrative Officer II</option>
                                        <option value="Administrative Officer III" <?= ($user['position_title'] ?? '') === 'Administrative Officer III' ? 'selected' : '' ?>>Administrative Officer III</option>
                                        <option value="Administrative Officer IV" <?= ($user['position_title'] ?? '') === 'Administrative Officer IV' ? 'selected' : '' ?>>Administrative Officer IV</option>
                                        <option value="Administrative Officer V" <?= ($user['position_title'] ?? '') === 'Administrative Officer V' ? 'selected' : '' ?>>Administrative Officer V</option>
                                        <option value="Registrar I" <?= ($user['position_title'] ?? '') === 'Registrar I' ? 'selected' : '' ?>>Registrar I</option>
                                        <option value="Registrar II" <?= ($user['position_title'] ?? '') === 'Registrar II' ? 'selected' : '' ?>>Registrar II</option>
                                    </optgroup>
                                    <optgroup label="Specialized Positions">
                                        <option value="Guidance Counselor I" <?= ($user['position_title'] ?? '') === 'Guidance Counselor I' ? 'selected' : '' ?>>Guidance Counselor I</option>
                                        <option value="Guidance Counselor II" <?= ($user['position_title'] ?? '') === 'Guidance Counselor II' ? 'selected' : '' ?>>Guidance Counselor II</option>
                                        <option value="Guidance Counselor III" <?= ($user['position_title'] ?? '') === 'Guidance Counselor III' ? 'selected' : '' ?>>Guidance Counselor III</option>
                                        <option value="Librarian I" <?= ($user['position_title'] ?? '') === 'Librarian I' ? 'selected' : '' ?>>Librarian I</option>
                                        <option value="Librarian II" <?= ($user['position_title'] ?? '') === 'Librarian II' ? 'selected' : '' ?>>Librarian II</option>
                                        <option value="Nurse I" <?= ($user['position_title'] ?? '') === 'Nurse I' ? 'selected' : '' ?>>Nurse I</option>
                                        <option value="Nurse II" <?= ($user['position_title'] ?? '') === 'Nurse II' ? 'selected' : '' ?>>Nurse II</option>
                                    </optgroup>
                                </select>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group" style="grid-column: span 2;">
                                ...
                                <input type="text" name="educational_degree" class="form-control" value="<?= htmlspecialchars($user['educational_degree'] ?? '') ?>" placeholder="e.g. Master of Arts in Administration">
                            </div>
                        </div>
                        <div class="form-grid">
                            <div class="form-group">
                        ...
                        <div style="border-top: 1px dashed #e2e8f0; margin: 32px 0; padding-top: 32px;">
                            ...
                            <div style="display: flex; gap: 24px; align-items: center; background: #f8fafc; padding: 24px; border-radius: 20px; border: 2px dashed #cbd5e1;">
                                ...
                                <div>
                                    ...
                                    <button type="button" class="btn btn-outline clickable" onclick="document.getElementById('sigInput').click()" style="background: white; border: 1px solid #cbd5e1;">
                        ...
                        <div style="text-align: right; margin-top: 24px;">
                            <button type="submit" class="btn btn-primary clickable">Update Professional Profile</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div style="text-align: right; margin-top: 24px;">
                            <button type="submit" class="btn btn-primary clickable">Secure New Password</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        // Add listeners for SG inputs to sync them
